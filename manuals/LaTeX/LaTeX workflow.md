...
## Latex Workshop in Cursor
In cursor, it may happen that the LaTeX Workshop container disappears from the primary sidebar (no icon for it int the sidebar container selector). To fix this:

1. close Cursor
1. go to `%appdata%\Cursor\User\globalStorage`
1. delete the `storage.json` file
